...
\draw[arrow] (state1) [out=-110, in=-160, looseness=8] to node [below, -] {$\backdel, |S| > 1\ \Big|\ -$} (state1);
...
\draw[arrow] (state2) [out=-20, in=-70, looseness=8] to node [below, -] {$\backdel\ \Big|\ \text{filter predictions}$} (state2);

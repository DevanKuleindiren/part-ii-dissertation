...
$outputs$ denotes the probability distribution returned by the RNN-based language model, which is indexable by word, and $state$ represents the state of the RNN from the previous time step.

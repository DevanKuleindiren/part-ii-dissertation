...
\begin{axis}[
    title={Perplexity of N-gram models trained on the PTB dataset.},
    xlabel={N},
    ylabel={Perplexity},
    xmin=2, xmax=5,
    ymin=100, ymax=340,
    xtick={2, 3, 4, 5},
    ytick={100, 120, 140, 160, 180, 200, 220, 240, 260, 280, 300, 320, 340},
...
coordinates {(2, 194.81)(3, 256.95)(4, 305.33)(5, 314.49)};

\addplot[color=red, mark=square]
coordinates {(2, 195.28)(3, 166.03)(4, 165.09)(5, 167.38)};

\addplot[color=green, mark=square]
coordinates {(2, 186.80)(3, 150.73)(4, 146.02)(5, 146.35)};

\addplot[color=violet, mark=square]
coordinates {(2, 185.72)(3, 149.54)(4, 144.38)(5, 142.68)};

\legend{Katz, Absolute Discounting, Kneser-Ney, Modified Kneser-Ney}
...
\begin{tabular}{| L{5cm} | C{2.5cm} | C{2cm} | C{2cm} | C{2cm} | C{2cm} |}
	...
	3-gram & 454267.15 & 1.97123 & 0.35014 & \tbf{266.91} & 62 \\
...
\begin{axis}[
    title={Perplexity on Cambridge Learner Corpus},
...
\addplot[color=black]
coordinates {(1, 89.70)(2, 89.70)(3, 89.70)};

\addplot[color=red, mark=square]
coordinates {(1, 88.47)(2, 88.47)(3, 88.47)};

\addplot[color=black]
coordinates {(1, 77.83)(2, 77.83)(3, 77.83)};

\legend{LSTM (error-free input), Error-Correcting LSTM (error-prone input), LSTM (error-prone input)}
